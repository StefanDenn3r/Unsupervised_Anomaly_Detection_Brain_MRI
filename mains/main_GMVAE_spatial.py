...
from models.gaussian_mixture_variational_autoencoder_spatial import gaussian_mixture_variational_autoencoder_spatial
...
model = GMVAE_spatial(tf.Session(), config, network=gaussian_mixture_variational_autoencoder_spatial)
