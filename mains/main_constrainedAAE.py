...
from models.constrained_adversarial_autoencoder import constrained_adversarial_autoencoder
...
model = ConstrainedAAE(tf.Session(), config, network=constrained_adversarial_autoencoder)
